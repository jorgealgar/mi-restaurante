...
const PLatosPrincipales = (img, text) => {
  const text1 =
    "Brócoli con Carne: Descripción: Brócoli salteado al wok con tiras de carne marinada Técnica: Salteado rápido para conservar crujiente del brócoli";
  const text2 =
    "Carpaccio de Atún : Descripción: Finas láminas de atún fresco marinado, cortadas casi transparentes";
  const text3 =
